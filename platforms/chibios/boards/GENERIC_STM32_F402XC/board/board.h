 ...
 * GPIOE setup:
 *
 * PE0  - PIN6                      (input pullup).
 * PE1  - PIN6                      (input pullup).
 * PE2  - PIN6                      (input pullup).
 * PE3  - PIN6                      (input pullup).
 * PE4  - PIN6                      (input pullup).
 * PE5  - PIN6                      (input pullup).
...
#define VAL_GPIOE_AFRL              (PIN_AFIO_AF(GPIOE_PIN6, 0U) |          \
