...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FN] = LAYOUT_94_jis(
        ...
        _______,  _______,  BL_DOWN,  _______,  _______,  _______,  _______,  _______,  _______,  KC_SNAP,  KC_PGDN,  KC_END,   _______,   _______,            _______,  _______,  _______,
    ...
    [WIN_FN] = LAYOUT_94_jis(
        ...
        _______,  _______,  BL_DOWN,  _______,  _______,  _______,  _______,  _______,  _______,  KC_PSCR,  KC_PGDN,  KC_END,   _______,   _______,            _______,  _______,  _______,
        _______,            _______,  _______,  _______,  _______,  BAT_LVL,  NK_TOGG,  _______,  _______,  _______,  _______,  _______,   _______,                      _______,
        _______,  _______,  _______,  _______,                      _______,                      _______,  _______,  _______,  _______,   _______,            _______,  _______,  _______),
};
