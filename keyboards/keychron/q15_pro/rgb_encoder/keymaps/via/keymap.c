...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_54_ansi(
        ...
        KC_LCTL,  KC_LOPTN, KC_LCMMD, MO(MAC_FN), KC_SPC,           KC_SPC,   KC_SPC,             KC_ROPTN, MO(FN2),  KC_LEFT,  KC_DOWN,  KC_RIGHT),
    [MAC_FN] = LAYOUT_54_ansi(
    ...
    [WIN_BASE] = LAYOUT_54_ansi(
        ...
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,   KC_PGUP,
        KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,    KC_PGDN,
        KC_LCTL,  KC_LWIN,  KC_LALT,  MO(WIN_FN),KC_SPC,            KC_SPC,   KC_SPC,             KC_RALT,  MO(FN2),  KC_LEFT,  KC_DOWN,  KC_RGHT),
    [WIN_FN] = LAYOUT_54_ansi(
